...
function CardHouseVIP({ id_biens, description, type_bien, adresse, ville,
   code_postal, prix_estime, etat, nbrChambre, Proprietaire, token, onInterestedClick,type_location_vip }) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <p className='block border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline w-full'
      >{type_bien}</p>
        <p className="text-xl mb-2">Type location: </p>
      <p className='block border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline w-full'
      >{type_location_vip}</p>

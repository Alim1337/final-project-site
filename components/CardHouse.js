    ...
    <div className="bg-white rounded-lg shadow-md p-6">
     ...
     <div className='pl-7'>
      {decodedToken && decodedToken.id === Proprietaire.id_proprietaire ? (
        ...
        token && (
          <button
            className="border border-red-500  text-red-500 border-2xl bg-white px-8 py-4 font-mono shadow-md rounded-full font-bold my-3 hover:shadow-2xl active:scale-90 transition duration-150"
